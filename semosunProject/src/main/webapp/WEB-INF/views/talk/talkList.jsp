            ...
            <div class="container">
                <div class="row sidebar-page">
                    ...
                    <div class="col-md-9 page-content">
                        ...
                        <div data-appeared-items="1" class="appendReady">
							...
							<c:forEach items="${list }" var="data">
							 <div class="testimonial">
								...
								function insert(){
							        ...
							        if(contentt.length == 0) {
								        ...
								        $.ajax({
								            ...
								            data : {userno : 1 , talkcontent : contentt},
								            dataType: "json",
								            success : function(data){
													...
													//     <div class="testimonial_author clearfix">
													//         <img class="testimonial_photo" src="${pageContext.request.contextPath}/resources/images/mini-profile.png" >
													//         <h3 class="testimonial_name">${member.Nickname} </h3>
													//         <div class="testimonial_position">작성일 시간</div>
													//     </div>
													// // </div>
								...
								// 무한 페이징 
								var currentPage = 2;
								var maxPage = Math.ceil(('${totalContents}') / 5); 
                        ...
                        <div class="custom-testimonial-item col-md-6">
                            <div class="custom-testimonial-user">
...
// 					</div>
 		            		...
 		            		var $textarea = $('<textarea>').addClass("reply-content").attr('cols','71%').attr('rows','3').attr('readonly','readonly').text(data.list[tt].ccontent);
	...
	function insertConmment(){
        ...
        if(contentt.length == 0) {
	        ...
	        $.ajax({
	            ...
	            data : {talkno: talkno , userno : 1 , ccontent : contentt},
	            dataType: "json",
	            success : function(data){

...
<body>
					...
					<div class="jsx-707316887 my-snb" style="height:500px; width:400px">
						...
						<ul class="jsx-707316887">
							<li class="jsx-707316887 active"><a class="jsx-707316887"
								href="${pageContext.request.contextPath }/myPage/myPage.do" style="text-decoration: none; margin-top: 20px;">프로필</a></li>
							<li class="jsx-707316887 "><a class="jsx-707316887"
								href="${pageContext.request.contextPath }/myPage/myPage2.do" style="text-decoration: none; margin-top: 20px;">기본정보</a></li>
							<li class="jsx-707316887 "><a class="jsx-707316887"
								href="/mypage/tutors" style="text-decoration: none; margin-top: 20px;">팔로우</a></li>
						</ul>
					...
					<div class="jsx-2123435526 content">
						<div class="jsx-1936111413 card" style="height: 500px;">
							<div class="jsx-1936111413 title">
								<h2 class="jsx-1936111413">프로필 카드</h2>
									...
									<div class="jsx-2014955477 photo-upload-preview">
										<div class="jsx-3815033897 avatar">
											<div class="jsx-3815033897 circle"
												style="background-image: url(&quot;https://d1ta1myjmiqbpz.cloudfront.net/static/images/default_image/default_user02_02@2x.png&quot;);"></div>
											<input type="file" id="206fe538-b5a2-41b7-8e8c-b2e02db8b307"
												accept="image/*" class="jsx-2014955477"><label
										...
										<div class="jsx-1936111413 join-date">
											...
											<div class="jsx-3664481379 input">
													<input readonly="" class="jsx-3664481379 "
														value="2019-12-24 16:01:33">
												</div></label>
										</div>
										<div class="jsx-1936111413 review-access">
											<label class="jsx-3712571264 "><span
												class="jsx-3712571264">리뷰열람&nbsp;</span>
											<div class="jsx-1936111413 input-box">
													<div class="jsx-1773881408 input">
														<input readonly="" class="jsx-1773881408 " value="열람불가"
															style="font-weight: bold;">
													</div>
													<button type="button" class="jsx-1936111413 " style="right:100px;" >열람권한
														얻기</button>
												</div></label>
										</div>
									</div>
						...
						<div class="jsx-1936111413 btn-save">
							<button type="button" class="jsx-315148180 ">수정 저장</button>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="/_next/static/chunks/styles.907b7a84a01942e8d49f.js"
		async=""></script>
	<img
		src="chrome-extension://ggjohpipgoocjmnkpleikjkljlimillm/images/memo_button.png"
		id="memoButton"
		style="z-index: 100000 !important; position: fixed !important; right: 13px !important; bottom: 23px !important; height: 60px !important; width: auto !important; cursor: pointer !important;">
	<div>
		<div class="memo_box" style="display: none;">
			<div class="memo_bottom_in">
				<div class="memo_text_area">
					<textarea class="memo_text" id="memo_area" name="메모입력" rows="1"
						cols="1" placeholder="메모를 입력하세요."></textarea>
					<div class="memo_submit_button">
						<input class="submit_button" type="submit" id="memo_submit"
							value="저장"> <input class="cancel_button2" type="submit"
							value="취소">
					</div>
				</div>
			</div>
